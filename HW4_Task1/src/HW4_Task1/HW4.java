...
public class HW4 {
    ...
    public static void main(String[] args) throws IOException {
		...
		writer.println("Ranking (Top 100) for the queries in Queries.txt in the format:");
		writer.println("query_id Q0 doc_id rank Lucene_score system_name");
		
	    try {
	    	String contents = new String(Files.readAllBytes(Paths.get("Queries.txt")));
